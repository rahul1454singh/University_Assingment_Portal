...
const StudentMessages = () => {
  ...
  return (
    <StudentLayout title="Professor Messages" userName={currentUser?.name}>
      <div className="messages-page animate-fade-in">
        ...
        <div className="messages-select-bar card" style={{ padding: "16px 20px", marginBottom: "16px" }}>
          <label style={{ fontSize: "13.5px", fontWeight: 700, color: "var(--text-primary)", display: "flex", alignItems: "center", gap: "8px", marginBottom: "8px" }}>
            ...
            <span>Select Professor to Chat:</span>
          </label>
          <MessageContactDropdown
            placeholder="Select a professor to start chatting..."
            options={contacts}
        ...
        <div className="messages-container card">
          ...
          <div className="contacts-sidebar">
            <div className="contacts-header">
              <h3 className="contacts-title">Enrolled Professors</h3>
            </div>

            <div className="contacts-list">
              {loadingContacts ? (
                <p style={{ textAlign: "center", color: "var(--text-muted)", padding: "20px" }}>Loading professors...</p>
              ) : contacts.length === 0 ? (
                <p style={{ textAlign: "center", color: "var(--text-muted)", padding: "20px", fontSize: "13px" }}>
                  No professors found in your department.
                </p>
              ) : (
                contacts.map((c) => {
                  const isSel = selectedContact?._id === c._id;
                  const firstLetter = c.name ? c.name.charAt(0).toUpperCase() : "P";
                  return (
                    <div
                      key={c._id}
                    ...
                    >
                      ...
                      <div className="contact-info">
                        <p className="contact-name">Prof. {c.name}</p>
          ...
          <div className="chat-panel">
            {selectedContact ? (
              <>
                ...
                <div className="chat-header">
                  <div className="chat-header-user">
                    <div className="avatar-wrapper">
                      {selectedContact.profileImage ? (
                        ...
                        <div className="contact-avatar">
                          {selectedContact.name ? selectedContact.name.charAt(0).toUpperCase() : "P"}
                        </div>
                      )}
                    ...
                    <div>
                      <h3 className="header-name">Prof. {selectedContact.name}</h3>
                ...
                <div className="messages-history">
                  {loadingMessages ? (
                    ...
                    <div className="empty-chat-state">
                      ...
                      <p>Start a direct conversation with Prof. {selectedContact.name}.</p>
                    </div>
                  ) : (
                    (() => {
                      let lastDateLabel = "";
                  ...
                  {isTyping && (
                    <div className="typing-indicator-bar">
                      Prof. {selectedContact.name} is typing...
                    </div>
                  )}
              ...
              <div className="empty-chat-state">
                ...
                <h3>Select a professor to start chatting</h3>
